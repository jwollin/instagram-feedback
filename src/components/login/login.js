...
export const Login = () => {
    ...
    const name = useSelector(state => getUsersName(state));
    const authenticated = useSelector(state => getUserAuthentication(state));

    return !authenticated ? (
        <Modal isOpen={!authenticated} className="login-modal">
            <ModalHeader>
                <Header
                    text="Login"
                    Element="h2"
            ...
            <ModalBody>
                <form>
                    <label
                        htmlFor="username"
                        className={`${username ? 'label-up' : ''} col-form-label-sm`}
                    >
                        Username
                    </label>
                    <input
                    ...
                    <label
                        htmlFor="password"
                        className={`${password ? 'label-up' : ''} col-form-label col-form-label-sm`}
                    >
                        Password
                    </label>
                    <input
